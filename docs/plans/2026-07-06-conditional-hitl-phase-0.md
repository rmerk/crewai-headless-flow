...
- OpenWiki / Domain Model Integration — was orthogonal to Phase 0 at the time; later rejected entirely (ADR-0011). Any domain-aware HITL trigger remains out of scope unless a future ADR reopens target-repo domain grounding.
